      ...
      >
        ...
        <div className="max-w-7xl mx-auto  w-full">
              ...
              {benefits.map((item, index) => (
                <div key={index} className="flex gap-4 items-center ">
                  <div className="  flex items-center justify-center gap-4">
                    <CheckIcon
                      className={`w-9 h-9 bg-black-100 text-lime rounded-full p-2`}
                    />
                    <div>
          ...
          <div className="relative mt-20 bg-black-100 rounded-2xl text-center flex flex-col justify-center items-center gap-8 p-10   ">
            ...
            <h2 className="text-4xl font-semibold text-lime">
              Bikin Website Kamu Segera
            </h2>
            <p className="text-white">
              Miliki Website dengan Design Professional dan Fitur-Fitur yang
              diperlukan untuk meningkatkan Bisnis Anda
            </p>
            <div className="flex gap-10">
              <Button
                variant="outline"
                onClick={() => sendWhatsapp("")}
                className="group border-0 hover:text-primary w-32 h-10 rounded-full  bg-lime cursor-pointer"
              >
                Get Started
              </Button>
              <Button
